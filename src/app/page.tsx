...
export default function Home() {
  ...
  useEffect(() => {
    // Redirect when user is authenticated and connected
    if (user) {
  ...
  const WalletButton = () => (
    <div className="px-5 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold shadow-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-200 cursor-pointer">
                  ...
                  <div className="relative bg-gray-800 border border-gray-700 rounded-xl overflow-hidden">
                    ...
                    <div className="p-4">
                      <div className="text-sm font-mono text-gray-300">
                        ...
                        <div className="text-purple-400">{/* VSCode Extension */}</div>
                        <div className="mt-4">
          ...
          <div className="container mx-auto text-center">
            ...
            {user ? (
              <div className="text-green-400 text-lg mb-4">
                ✓ Wallet Connected - Redirecting to Chat Interface...
              </div>
            ) : (
              <>
                <div className="w-full items-center flex justify-center mb-8">
                  <DynamicWidget innerButtonComponent={<WalletButton />} />
                </div>
